...
class APIHandler( ):
	...
	def crop_video( ):
		...
		print( '> Downloading' )
		dl_command = " youtube-dl -g --merge-output-format mp4 {} | sed 's/^/-ss {} -i /' ".format( args[ 'url' ], args[ 'start_time' ] )
		...
		print( '> Cutting' )
		cut_command = "ffmpeg {} -t {} -c copy {}".format( dl_output, args[ 'duration' ], video_tmp_filename )
