...
class APIHandler( ):
	...
	def crop_video( ):
		...
		command = "ffmpeg $(youtube-dl -v -g -f 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/mp4' '{}' | sed 's/^/-ss {} -i /') -t {} -c copy {}".format( args[ 'url' ], args[ 'start_time' ], args[ 'duration' ], video_tmp_filename )
